$(function () {
    ...
    var calculateFixedBuying = function () {
        ...
        var returnOnDeposit = oneYearReturn / deposit;
        var resultingGrossYield = weeklyRent * 52 / purchasePrice;
        var resultingNetYield = (weeklyRent * 52 - purchasePrice) / amountOfLoan;
